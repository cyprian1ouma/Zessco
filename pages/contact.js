      ...
      <main className="bg-gray-50 pt-16 pb-20 px-6">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-7xl mx-auto mt-4 pt-5">
                ...
                <div>
                    ...
                    <a href="#" className="text-blue-600 hover:scale-110 transition text-xl"><FaFacebookF /></a>
                    <a href="#" className="text-pink-500 hover:scale-110 transition text-xl"><FaInstagram /></a>
                    <a href="#" className="text-blue-800 hover:scale-110 transition text-xl"><FaLinkedinIn /></a>
                    <a href="#" className="text-black hover:scale-110 transition text-xl"><FaXTwitter /></a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <button type="submit" className="bg-blue-700 text-white py-3 px-6 rounded hover:bg-blue-800 transition">
                        Send Message
                    </button>
                    </form>
                </div>
...
// This code defines a Contact page for a logistics company, including a map, contact information, a contact form, and an animated section displaying different tenders offered by the company.