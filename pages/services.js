              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={item.step} className="flex items-start gap-4">
                    <div className={`flex-shrink-0 w-4 h-4 rounded-full flex items-center justify-center font-semibold text-white`}
          ...
          <div className="sticky bottom-0 bg-gray-50 border-t border-gray-200 px-8 py-5">
            <div className="flex flex-col sm:flex-row gap-3 justify-end">
              ...
              <a
                ...
                className={`px-6 py-2.5 text-white rounded-lg transition-colors font-small inline-flex items-center justify-center gap-2 ${colorScheme.button}`}
              >
