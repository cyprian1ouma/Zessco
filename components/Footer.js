          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a className="text-white hover:underline" href="/tender">Tender</a></li>
                <li><a className="text-white hover:underline" href="/services">Services</a></li>
                <li><a className="text-white hover:underline" href="/aboutus">About</a></li>
                <li><a className="text-white hover:underline" href="/contact">Contact</a></li>
              </ul>
            </div>
